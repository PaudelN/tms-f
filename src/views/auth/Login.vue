  ...
  >
    ...
    <div class="relative z-10 w-full max-w-lg mx-4">
      ...
      >
        ...
        <!-- Divider -->
        <div class="relative my-6 animate-fade-in [animation-delay:0.5s]">
        ...
        <div class="mt-6 text-center animate-fade-in [animation-delay:0.7s]">
