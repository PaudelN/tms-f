  ...
  >
    <div class="absolute inset-0 overflow-hidden opacity-5">
      <div class="absolute top-20 left-10 animate-float">
        <LogIn class="w-20 h-20 text-primary" />
      </div>
    ...
    <div class="relative z-10 w-full max-w-lg mx-4">
      ...
      >
        ...
        <form @submit.prevent="handleLogin" class="space-y-5">
          <!-- Email Field -->
          <div class="space-y-2 animate-fade-in [animation-delay:100ms]">
            <Label
          ...
          <!-- Password Field -->
          <div class="space-y-2 animate-fade-in [animation-delay:200ms]">
            <Label
              class="text-sm font-medium text-foreground flex items-center gap-2"
            >
              <Lock class="w-4 h-4" />
          ...
          <div
            class="flex items-center justify-between animate-fade-in [animation-delay:300ms]"
          >
        ...
        <!-- Divider -->
        <div
          class="relative my-6 animate-fade-in [animation-delay:500ms]"
        >
        ...
        <div
          class="grid grid-cols-2 gap-3 animate-fade-in [animation-delay:600ms]"
        >
          <Button
            type="button"
            variant="outline"
        ...
        <div
          class="mt-6 text-center animate-fade-in [animation-delay:700ms]"
        >
        ...
        <div
          class="mt-6 flex items-center justify-center gap-2 text-muted-foreground text-xs animate-fade-in [animation-delay:800ms]"
        >
