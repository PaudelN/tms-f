    ...
    <div class="relative z-10 w-full max-w-lg mx-4">
      ...
      >
        ...
        <form @submit.prevent="handleRegister" class="space-y-5">
          <div class="space-y-2 animate-fade-in [animation-delay:0.1s]">
            <Label
          ...
          <div class="space-y-2 animate-fade-in [animation-delay:0.2s]">
            <Label
              class="text-sm font-medium text-foreground flex items-center gap-2"
            >
              <Mail class="w-4 h-4" />
          ...
          <div class="space-y-2 animate-fade-in [animation-delay:0.3s]">
            <Label
              class="text-sm font-medium text-foreground flex items-center gap-2"
            >
              <Lock class="w-4 h-4" />
          ...
          <div class="space-y-2 animate-fade-in [animation-delay:0.4s]">
            <Label
              class="text-sm font-medium text-foreground flex items-center gap-2"
            >
        ...
        <div class="mt-6 text-center animate-fade-in [animation-delay:0.6s]">
        ...
        <div class="mt-6 flex items-center justify-center gap-2 text-muted-foreground text-xs animate-fade-in [animation-delay:0.7s]">
