      ...
      <Card class="border-border rounded-lg">
        <CardContent class="px-5 py-4 space-y-3">
          ...
          <ul class="space-y-1.5">
            ...
            >
              <ChevronRight
                class="h-3 w-3 shrink-0 mt-0.5 text-muted-foreground"
              />
              {{ tip }}
            </li>
          </ul>
      ...
      <form @submit.prevent>
        ...
        <div class="px-10 pt-8 pb-6 border-b">
          <div class="flex items-start gap-4">
            <div
              class="h-10 w-10 rounded-xl bg-primary-20 flex items-center justify-center shrink-0"
            >
            ...
            <div>
              ...
              <p class="text-[13px] text-muted-foreground mt-0.5">
                Create a new project inside this workspace to organise your
                team's work.
              </p>
            </div>
          </div>
...
import { useProjectStore } from "@/stores/project";
  ...
  const onSubmit = handleSubmit(async (formValues) => {
    ...
    try {
      ...
      notify.success(
        "Project created",
        `"${project.name}" is now ready to use.`,
      );
  ...
  const breadcrumbs: FormBreadcrumb[] = [{ label: "New Project" }];
</script>
