    ...
    <div class="max-w-3xl mx-auto">
      ...
      <div v-if="loading" class="flex items-center justify-center py-20">
        <div class="text-center">
          <Loader2 class="animate-spin h-12 w-12 text-primary mx-auto mb-4" />
            ...
            <form @submit.prevent="handleSubmit" class="space-y-6">
              ...
              <div class="flex gap-3 pt-4">
                ...
                <Button
                  ...
                  class="flex-1 gap-2"
                >
                  <Loader2 v-if="workspaceStore.isLoading" class="animate-spin h-4 w-4" />
...
import { AlertCircle, ArrowLeft, Loader2, Pencil } from "lucide-vue-next";
