<template>
  <div class="pagination-shell flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between select-none">
    ...
    <div class="flex flex-wrap items-center gap-2">
      <div class="rows-control">
        ...
        <Select :model-value="String(perPage)" @update:model-value="handlePerPageChange">
          <SelectTrigger
            class="rows-trigger text-foreground focus:ring-0 focus:ring-offset-0 focus-visible:ring-0 focus-visible:ring-offset-0"
          >
