<template>
  <div class="flex flex-col gap-4 px-1 py-2 md:flex-row md:items-center md:justify-between">
    ...
    <div class="flex flex-wrap items-center gap-3">
      <div class="flex items-center gap-2">
        <label for="perPage" class="text-xs text-muted-foreground">Per page:</label>
        <Select :model-value="perPage.toString()" @update:model-value="handlePerPageChange">
          <SelectTrigger id="perPage" class="h-8 w-[90px]">
      ...
      <div class="flex items-center gap-1">
        ...
        <Button
          ...
          :class="page === currentPage ? 'bg-primary text-primary-foreground border-primary' : ''"
