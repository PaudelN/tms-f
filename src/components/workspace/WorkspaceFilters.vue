<template>
  <div class="bg-card rounded-xl shadow-sm border border-border p-4">
      ...
      <div class="flex items-end gap-2">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger as-child>
            <Button variant="secondary" class="whitespace-nowrap">Export</Button>
          </DropdownMenuTrigger>
        ...
        <Button variant="secondary" class="whitespace-nowrap" @click="emit('share')">Share</Button>
      </div>
    </div>
    ...
    <div v-if="hasActiveFilters" class="mt-4 flex items-center gap-2 flex-wrap">
      ...
      <Button size="sm" variant="destructive" class="text-xs" @click="emit('clearAllFilters')">
        Clear all
      </Button>
    </div>
  </div>
