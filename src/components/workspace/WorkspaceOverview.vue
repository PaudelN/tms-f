  ...
  <div class="space-y-6">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
      ...
      <div class="bg-card rounded-2xl p-6 shadow-sm border border-border hover:shadow-md transition-shadow">
        ...
        <Progress :model-value="progressPercentage.active" indicator-class="bg-green-500" />
      </div>
      ...
      <div class="bg-card rounded-2xl p-6 shadow-sm border border-border hover:shadow-md transition-shadow">
        ...
        <Progress :model-value="progressPercentage.archived" indicator-class="bg-orange-500" />
      </div>
      ...
      <div class="bg-card rounded-2xl shadow-sm border border-border overflow-hidden">
        ...
        <div class="p-4 max-h-72 overflow-y-auto">
          <div v-if="pinnedWorkspaces.length === 0" class="text-center py-8">
            <Sparkles class="w-10 h-10 text-muted-foreground mx-auto mb-2" />
...
import { BarChart3, CheckCircle2, Clock, Folder, Sparkles, Star, Trophy, TrendingUp, Archive } from "lucide-vue-next";
